...
var ColorPickerComponent = class _ColorPickerComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ColorPickerComponent, selectors: [["aida-color-picker"]], inputs: { key: "key", initialColor: "initialColor", externalShades: "externalShades", contrastTests: "contrastTests", showReset: "showReset" }, outputs: { colorChanged: "colorChanged" }, features: [\u0275\u0275NgOnChangesFeature], decls: 8, vars: 4, consts: [[1, "flex", "flex-column", "gap-2"], [1, "flex", "align-items-center", "gap-2", "mb-2"], ["appendTo", "body", 3, "ngModelChange", "onChange", "ngModel"], ["type", "text", "pInputText", "", "placeholder", "#000000", 3, "ngModelChange", "change", "ngModel"], [1, "text-xs"], ["label", "Reset", "size", "small", "text", "", "severity", "secondary", 1, "w-full", "h-full", 3, "onClick"], [1, "flex", "align-items-center", "justify-content-between"], [1, "flex", "align-items-center", "gap-2"], [1, "font-semibold"], [1, "pi"]], template: function ColorPickerComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(6, ColorPickerComponent_Conditional_6_Template, 2, 0, "p-inputgroup-addon");
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(7, ColorPickerComponent_Conditional_7_Template, 3, 0, "div", 4);
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.contrastTests && ctx.contrastTests.length > 0 ? 7 : -1);
    }
  }, dependencies: [CommonModule, FormsModule, DefaultValueAccessor, NgControlStatus, NgModel, ColorPickerModule, ColorPicker, InputTextModule, InputText, ButtonModule, Button, InputGroupModule, InputGroup, InputGroupAddonModule, InputGroupAddon], encapsulation: 2 });
};
(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ColorPickerComponent, { className: "ColorPickerComponent", filePath: "src/app/views/standalone/components/dev-tools/color-generator/color-picker.component.ts", lineNumber: 67 });
})();
