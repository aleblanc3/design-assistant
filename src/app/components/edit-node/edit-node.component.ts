...
@Component({
  ...
  imports: [CommonModule, FormsModule, TranslatePipe, ButtonModule, CheckboxModule, FieldsetModule, IftaLabelModule, InputGroupAddonModule, InputGroupModule, InputTextModule, MessageModule, SelectButtonModule, SelectModule, TagModule, TextareaModule],
