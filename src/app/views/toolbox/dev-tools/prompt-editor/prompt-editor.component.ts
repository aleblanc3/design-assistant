...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, RouterLink, TranslatePipe, BreadcrumbModule, ButtonModule, CheckboxModule, FieldsetModule, IftaLabelModule, MessageModule, MultiSelectModule, ProgressSpinnerModule, RadioButtonModule, SelectModule, TabsModule, TextareaModule],
