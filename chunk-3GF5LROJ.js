...
var COLUMN_GROUPS = ["page", "oppPage", "github", "status", "problems", "pageData", "owner", "metadata"];
...
var FetchService = class _FetchService {
  ...
  getOppMetadata(url) {
    return __async(this, null, function* () {
      const doc = yield this.fetchContent(url, "prod", 3, "none", true);
      const h1Elements = Array.from(doc.querySelectorAll("h1")).filter((h12) => !h12.classList.contains("wb-inv"));
      const h1Texts = h1Elements.map((e) => e.textContent?.trim()).filter(Boolean);
      let doubleH1 = doc.querySelector("hgroup p:has(+ h1)")?.innerHTML || doc.querySelector("p.lead:has(+ h1)")?.innerHTML || "";
      let h1 = "";
    ...
    return __async(this, null, function* () {
      ...
      try {
        const [{ default: prettier }, parserHtml] = yield Promise.all([
          import("./chunk-SNN5DARO.js"),
          import("./chunk-N4GHWYKI.js")
        ]);
...
${scripts}`;
  ...
  formatNewPageAsJekyll(node, breadcrumbs, owner, repo, lang = "primary") {
...
`;
  ...
  generateMermaidChart(treeNodes) {
...
//# sourceMappingURL=chunk-3GF5LROJ.js.map
