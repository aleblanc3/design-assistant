...
var Pn = Cu((Mt) => {
  ...
  function ho(e, t, r) {
    let n = Object.assign({
      column: 0,
      line: -1
    }, e.start), u = Object.assign({}, n, e.end), {
      linesAbove: o = 2,
      linesBelow: i = 3
    } = r || {}, s = n.line, a = n.column, c = u.line, D = u.column, p = Math.max(s - (o + 1), 0), l = Math.min(t.length, c + i);
  ...
  function go(e, t, r = {}) {
    let u = Co(false), o = e.split(On), {
      start: i,
      end: s,
      markerLines: a
    } = ho(t, o, r), c = t.start && typeof t.start.column == "number", D = String(s).length, l = e.split(On, s).slice(i, s).map((F, f) => {
  ...
  function u(o) {
    switch (M(o)) {
      case Y:
        return t(o.map(n));
      case k:
        return t(__spreadProps(__spreadValues({}, o), {
          parts: o.parts.map(n)
        }));
      case _:
        return t(__spreadProps(__spreadValues({}, o), {
      ...
      case B: {
        ...
        return i ? (i = i.map(n), s = i[0]) : s = n(s), t(__spreadProps(__spreadValues({}, o), {
          contents: s,
          expandedStates: i
        }));
      }
...
function Fe(e, t) {
  return e.type === S ? __spreadProps(__spreadValues({}, e), {
...
function At(e, t = {}) {
  return K(e), yt(t.expandedStates, true), {
    type: B,
    id: t.id,
    contents: e,
    break: !!t.shouldBreak,
...
function Cr(e, t) {
  return At(e[0], __spreadProps(__spreadValues({}, t), {
    expandedStates: e
  }));
}
function hr(e) {
...
function Iu(e, t, r) {
  return t === Number.NEGATIVE_INFINITY ? e.root || Nr() : t < 0 ? xt(e, {
    type: "dedent"
  }, r) : t ? t.type === "root" ? __spreadProps(__spreadValues({}, e), {
    root: e
  }) : xt(e, {
...
function xt(e, t, r) {
  ...
  return l(), __spreadProps(__spreadValues({}, e), {
    value: u,
    length: o,
    queue: n
  });
...
`, u) : f;
      ...
      case k: {
        ...
        let lu = C[m + 2], Ft = {
          ind: l,
          mode: F,
          doc: __spreadProps(__spreadValues({}, f), {
            [_t]: m + 2
          })
        };
        Ke({
          ...
          mode: H,
          doc: [h, x, lu]
        }, [], d, c.length > 0, r, true) ? i.push(Ft, Be, A) : ue ? i.push(Ft, lt, A) : i.push(Ft, lt, $);
        break;
      }
      case _:
      case v: {
...
function Xe(e, t) {
  ...
  if (!n) return [];
  let s = ((r == null ? void 0 : r(e, t)) ?? [...Ce(e, {
    getVisitorKeys: J(u)
  })]).flatMap((a) => n(a) ? [a] : Xe(a, t));
...
function Ur(e, t, r, n) {
  let {
    locStart: u,
    locEnd: o
  } = r, i = u(t), s = o(t), a = Xe(e, r), c, D, p = 0, l = a.length;
  for (; p < l; ) {
...
function Vr(e, t) {
  ...
  let n = [], {
    ...
    endOfLine: a = Nt,
    remaining: c = Nt
  } = o, D = r.map((p, l) => __spreadProps(__spreadValues({}, Ur(e, p, t)), {
    comment: p,
    text: i,
    options: t,
    ast: e,
...
function jr(e, t) {
  ...
  for (let [c, {
    comment: D
  }] of e.entries()) c < i ? ae(n, D) : se(u, D);
...
function Ju(e, t, r) {
  var c;
  let n = e.node, u = Wr(e, t), {
    printer: o,
    originalText: i,
    locStart: s
  } = t, a = (c = o.isBlockComment) == null ? void 0 : c.call(o, n);
...
function Qe({
  ...
  for (let u of Zu(Object.assign({}, ...e.map(({
    options: o
  }) => o), zr))) !t && u.deprecated || (Array.isArray(u.choices) && (t || (u.choices = u.choices.filter((o) => !o.deprecated)), u.name === "parser" && (u.choices = [...u.choices, ...Qu(u.choices, r, e)])), u.pluginDefaults = Object.fromEntries(e.filter((o) => {
    var i;
...
function un(e, t) {
  if (t) {
    ...
    if (typeof t == "string") return e.find(({
      isSupported: r
    }) => r == null ? void 0 : r({
      filepath: t
    }));
...
var fn = (e, t, r) => {
  let {
    text: n,
    list: u
  } = r.normalizeExpectedResult(r.schemas[e].expected(r)), o = [];
...
var et = (e, t, {
  ...
  let o = [`Ignored unknown option ${V.yellow(r.pair({
    key: e,
    value: t
...
var nt = class extends b {
  constructor(_a) {
    ...
    super(__spreadProps(__spreadValues({}, n), {
      name: r
    })), this._valueSchema = t;
  }
  expected(t) {
...
var it = class extends b {
  ...
  expected({
    ...
    let r = Array.from(this._choices.keys()).map((i) => this._choices.get(i)).filter(({
      hidden: i
    }) => !i).map((i) => i.value).sort(An).map(t.value), n = r.slice(0, -2), u = r.slice(-2);
    return {
...
function lo(e, t, {
  ...
  let s = u ? Array.isArray(u) ? (l, F) => u.includes(l) ? {
    ...
    return et(l, F, __spreadProps(__spreadValues({}, f), {
      schemas: m
    }));
  }, a = Fo(t, {
    isCLI: n,
...
function po(e, {
  ...
  switch (e.type) {
    ...
    case "string":
      ...
      break;
    case "choice":
      i = it, o.choices = e.choices.map((a) => a != null && a.redirect ? __spreadProps(__spreadValues({}, a), {
        redirect: {
          to: {
            key: e.name,
            value: a.redirect
  ...
  return e.array ? nt.create(__spreadProps(__spreadValues(__spreadValues({}, t ? {
    preprocess: (a) => Array.isArray(a) ? a : [a]
  } : {}), s), {
    valueSchema: i.create(o)
  })) : i.create(__spreadValues(__spreadValues({}, o), s));
}
var kn = lo;
var mo = (e, t, r) => {
  if (!(e && t == null)) {
...
function Eo(_0) {
  return __async(this, arguments, function* (e, t = {}) {
    ...
    let n = Qe({
      plugins: e.plugins,
      showDeprecated: true
    }).options, u = __spreadValues(__spreadValues({}, Nn), Object.fromEntries(n.filter((l) => l.default !== void 0).map((l) => [l.name, l.default]))), o = $t(r.plugins, r.parser), i = yield Wt(o, r.parser);
    r.astFormat = i.astFormat, r.locEnd = i.locEnd, r.locStart = i.locStart;
    let s = (p = o.printers) != null && p[i.astFormat] ? o : Sn(r.plugins, i.astFormat), a = yield Tn(s, i.astFormat);
    r.printer = a;
    ...
    return r.parser === "json" && (r.trailingComma = "none"), kn(r, n, __spreadValues({
...
function yo(e, t) {
  return __async(this, null, function* () {
    let r = yield Re(t), n = r.preprocess ? r.preprocess(e, t) : e;
    t.originalText = n;
    let u;
    try {
      u = yield r.parse(n, t, t);
    } catch (o) {
      Ao(o, e);
    }
    return {
...
function Bo(e, t, r, n) {
  return __async(this, null, function* () {
    let u = yield ne(__spreadProps(__spreadValues(__spreadValues({}, r), t), {
...
function xo(e, t) {
  let {
    ...
    locStart: n,
    locEnd: u
  } = t, o = J(t.printer.getVisitorKeys), i = (F) => n(F) <= r && u(F) >= r, s = e, a = [e];
  for (let F of Lr(e, {
    getVisitorKeys: o,
    filter: i
  })) a.push(F), s = F;
...
function Po(e, t) {
  return __async(this, null, function* () {
    let {
      ...
      rangeStart: u,
      rangeEnd: o
    } = Wn(n, t, r), i = n.slice(u, o), s = Math.min(u, n.lastIndexOf(`
`, u) + 1), a = n.slice(s, u).match(/^\s*/u)[0], c = Ee(a, t.tabWidth), D = yield Hn(i, __spreadProps(__spreadValues({}, t), {
      rangeStart: 0,
      rangeEnd: Number.POSITIVE_INFINITY,
      cursorOffset: t.cursorOffset > u && t.cursorOffset <= o ? t.cursorOffset - u : -1,
      endOfLine: "lf"
    }), c), p = D.formatted.trimEnd(), {
      cursorOffset: l
    } = t;
...
function Gn(e, t) {
  ...
  return r = Ht(e, r, -1), n = Ht(e, n, 0), u = Ht(e, u, e.length), __spreadProps(__spreadValues({}, t), {
    cursorOffset: r,
    rangeStart: n,
    rangeEnd: u
  });
...
`);
  ...
  return {
    hasBOM: i,
    text: e,
    options: Gn(e, __spreadProps(__spreadValues({}, t), {
      cursorOffset: r,
      rangeStart: n,
      rangeEnd: u,
      endOfLine: o
...
function Jt(e, t) {
  return __async(this, null, function* () {
    ...
    if (u.rangeStart >= u.rangeEnd && n !== "" || u.requirePragma && !(yield Kn(n, u)) || u.checkIgnorePragma && (yield vo(n, u))) return {
      formatted: e,
      cursorOffset: t.cursorOffset,
      comments: []
    };
    let o;
    return u.rangeStart > 0 || u.rangeEnd < n.length ? o = yield Po(n, u) : (!u.requirePragma && u.insertPragma && u.printer.insertPragma && !(yield Kn(n, u)) && (n = u.printer.insertPragma(n)), o = yield Hn(n, u)), r && (o.formatted = zn + o.formatted, o.cursorOffset >= 0 && o.cursorOffset++), o;
  });
}
function qn(e, t, r) {
  return __async(this, null, function* () {
    let {
      text: n,
      options: u
    } = Jn(e, yield ne(t)), o = yield De(n, u);
    return r && (r.preprocessForPrint && (o.ast = yield Gt(o.ast, u)), r.massage && (o.ast = Yn(o.ast, u))), o;
  });
}
function Xn(e, t) {
  return __async(this, null, function* () {
...
function Qn(e, t) {
  return __async(this, null, function* () {
    let r = wr(e), {
      formatted: n
    } = yield Jt(r, __spreadProps(__spreadValues({}, t), {
...
function ce(e, t = 1) {
  return (...r) => __async(null, null, function* () {
    ...
    return r[t] = __spreadProps(__spreadValues({}, n), {
...
function fu(e, t) {
  return __async(this, null, function* () {
    let {
      formatted: r
    } = yield cu(e, __spreadProps(__spreadValues({}, t), {
      cursorOffset: -1
    }));
    return r;
  });
...
//# sourceMappingURL=chunk-5L6VDSWV.js.map
