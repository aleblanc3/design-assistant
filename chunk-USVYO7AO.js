...
function PromptEditorComponent_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, PromptEditorComponent_ng_template_1_Conditional_0_Template, 3, 4, "a", 8)(1, PromptEditorComponent_ng_template_1_Conditional_1_Template, 3, 3, "span", 9);
  }
  if (rf & 2) {
...
function PromptEditorComponent_For_15_Conditional_2_For_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 13)(1, "p-radioButton", 14);
...
function PromptEditorComponent_For_15_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, PromptEditorComponent_For_15_Conditional_2_For_1_Template, 5, 7, "div", 13, _forTrack1);
  }
  if (rf & 2) {
...
function PromptEditorComponent_For_15_Conditional_3_For_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 16)(1, "p-checkbox", 14);
...
function PromptEditorComponent_For_15_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, PromptEditorComponent_For_15_Conditional_3_For_1_Template, 5, 7, "div", 16, _forTrack2);
  }
  if (rf & 2) {
    const tab_r7 = \u0275\u0275nextContext().$implicit;
...
function PromptEditorComponent_For_15_Conditional_5_For_1_Conditional_0_For_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "p-iftalabel")(1, "textarea", 18);
...
function PromptEditorComponent_For_15_Conditional_6_For_1_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 20)(4, "p-iftalabel", 21)(5, "p-select", 22);
    ...
    \u0275\u0275template(6, PromptEditorComponent_For_15_Conditional_6_For_1_Conditional_1_ng_template_6_Template, 2, 3, "ng-template", 2)(7, PromptEditorComponent_For_15_Conditional_6_For_1_Conditional_1_ng_template_7_Template, 2, 3, "ng-template", 23);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "label", 19);
    \u0275\u0275text(9);
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "p-iftalabel", 21)(12, "p-select", 22);
    ...
    \u0275\u0275template(13, PromptEditorComponent_For_15_Conditional_6_For_1_Conditional_1_ng_template_13_Template, 2, 3, "ng-template", 2)(14, PromptEditorComponent_For_15_Conditional_6_For_1_Conditional_1_ng_template_14_Template, 2, 3, "ng-template", 23);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "label", 19);
    \u0275\u0275text(16);
    \u0275\u0275pipe(17, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "p-iftalabel", 21)(19, "p-multiselect", 24);
    \u0275\u0275pipe(20, "translate");
    ...
    \u0275\u0275template(21, PromptEditorComponent_For_15_Conditional_6_For_1_Conditional_1_ng_template_21_Template, 2, 3, "ng-template", 2)(22, PromptEditorComponent_For_15_Conditional_6_For_1_Conditional_1_ng_template_22_Template, 2, 1, "ng-template", 25);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "label", 19);
    \u0275\u0275text(24);
    \u0275\u0275pipe(25, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(26, "p-iftalabel")(27, "textarea", 18);
...
function PromptEditorComponent_For_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-tabpanel", 5)(1, "div", 11);
...
function PromptEditorComponent_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "h2", 26);
    \u0275\u0275text(1, "Review changes");
    \u0275\u0275elementEnd();
    \u0275\u0275element(2, "div", 27);
    \u0275\u0275elementStart(3, "p-fieldset", 28)(4, "pre", null, 0)(6, "code", 29);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()()();
    \u0275\u0275element(8, "p-button", 30);
    \u0275\u0275pipe(9, "translate");
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r2.rebuildPromptFile(ctx_r2.tabs[ctx_r2.selectedTab].tool, ctx_r2.tabs[ctx_r2.selectedTab].prompts));
    \u0275\u0275advance();
    \u0275\u0275property("label", \u0275\u0275pipeBind1(9, 4, "dev.prompts.button.openPR"));
  }
}
...
${updatedPrompts}
  ...
  updateDiff() {
    return __async(this, null, function* () {
      ...
      const diff2htmlUi = new Diff2HtmlUI(document.getElementById("diff-container"), patch, config);
      diff2htmlUi.draw();
  ...
  highlightFilePreview() {
    return __async(this, null, function* () {
      if (!this.filePreview)
        return;
      try {
        const { default: Prism } = yield import("./chunk-OBAGABHE.js");
        yield import("./chunk-2EOVZ2WK.js");
        ...
        if (codeBlock) {
          ...
          codeBlock.textContent = this.rebuildPromptFile(this.tabs[this.selectedTab].tool, this.tabs[this.selectedTab].prompts);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PromptEditorComponent, selectors: [["aida-prompt-editor"]], viewQuery: function PromptEditorComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(11, PromptEditorComponent_For_12_Template, 3, 4, "p-tab", 5, _forTrack0);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(13, "p-tabpanels");
      \u0275\u0275repeaterCreate(14, PromptEditorComponent_For_15_Template, 7, 4, "p-tabpanel", 5, _forTrack0);
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275pipe(32, "json");
      \u0275\u0275elementEnd();
      \u0275\u0275template(33, PromptEditorComponent_Conditional_33_Template, 1, 0, "p-progressSpinner")(34, PromptEditorComponent_Conditional_34_Template, 1, 1, "p-message", 7)(35, PromptEditorComponent_Conditional_35_Template, 2, 1, "small")(36, PromptEditorComponent_Conditional_36_Template, 10, 6);
    }
    if (rf & 2) {
      \u0275\u0275property("model", ctx.breadcrumbs);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(4, 13, "dev.prompts._title"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate2("", \u0275\u0275pipeBind1(7, 15, "dev.prompts.description"), " ", \u0275\u0275pipeBind1(8, 17, "dev.prompts.description2"), "");
      \u0275\u0275advance(3);
      ...
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1("Response: ", \u0275\u0275pipeBind1(32, 19, ctx.response), "");
      \u0275\u0275advance(2);
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.hasChanges() ? 36 : -1);
    }
  }, dependencies: [
    CommonModule,
    JsonPipe,
...
@if(hasChanges()){\r
<!--Review-->\r
<h2 class="my-1">Review changes</h2>\r
<div id="diff-container"></div>\r
<!--Export-->\r
<p-fieldset legend="Full File Preview" [toggleable]="true" [collapsed]="true" styleClass="secondary-outline mb-3">\r
    <pre #filePreview><code class="language-typescript">{{ rebuildPromptFile(tabs[selectedTab].tool, tabs[selectedTab].prompts) }}</code></pre>\r
</p-fieldset>\r
<p-button [label]="'dev.prompts.button.openPR' | translate" icon="pi pi-send" disabled />\r
}` }]
  }], () => [], { filePreview: [{
    type: ViewChild,
    args: ["filePreview"]
...
//# sourceMappingURL=chunk-USVYO7AO.js.map
