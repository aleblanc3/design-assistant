...
var RouterLinkActive = class _RouterLinkActive {
  ...
  set routerLinkActive(data) {
    const classes4 = Array.isArray(data) ? data : data.split(" ");
    this.classes = classes4.filter((c) => !!c);
  }
  /** @docs-private */
  ngOnChanges(changes) {
    this.update();
    ...
    if (Array.isArray(o1)) {
      ...
      if ((length = o1.length) == o2.length) {
        for (key = 0; key < length; key++) {
          if (!equals2(o1[key], o2[key])) return false;
        }
        return true;
      }
    } else {
...
var TranslateDirective = class _TranslateDirective {
  ...
  set translateParams(params) {
    if (!equals2(this.currentParams, params)) {
...
var TranslatePipe = class _TranslatePipe {
  ...
  transform(query, ...args) {
    ...
    if (equals2(query, this.lastKey) && equals2(args, this.lastParams)) {
      return this.value;
    }
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-GMQXC5PB.js.map
